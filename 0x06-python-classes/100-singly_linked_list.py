#!/usr/bin/python3
"""
A module for singly linked list using python classes
"""


class Node:
    """
    class node used to create a node in a singly linked list
    """
    def __init__(self, data, next_node=None):
        """
        a method that initializes data and next node attributes
        """
        self.data = data
...
class SinglyLinkedList:
    ...
    def __init__(self):
        """
        initializes head attribute to None
        """
        self.__head = None
