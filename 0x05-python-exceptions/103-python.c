...
/**
 * print_python_list - Prints basic infomation on Python lists
...
/**
 * print_python_bytes - print basic infomation on Python byte objects
...
/**
 * print_python_float - Prints basic infomation on Python float objects
